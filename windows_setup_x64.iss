...
OutputBaseFilename=netlenium_v1.0.0.0_setup_x64
...
Name: "installdrivers"; Description: "Install Missing Drivers"
...
[Run]
Filename: "{app}\netlenium.exe"; Parameters: "--update"; Flags: waituntilterminated 64bit runhidden; StatusMsg: "Installing Drivers"; Tasks: installdrivers
